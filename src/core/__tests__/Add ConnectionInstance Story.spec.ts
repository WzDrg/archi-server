...
import { createConnectionInstance, updateConnectionInstance} from "../network/command/ConnectionInstance";
import { ConnectionInstance, connectionInstanceId, containerInstanceId } from "../network/model/Aggregates";
